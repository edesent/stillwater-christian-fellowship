...
export const visitorNotes = [
  {
    ...
    body: <>Led by our Pastor, we live by <i>"every word which proceedeth out of the mouth of God"</i><br />The Bible is God's Inerrant Word. It is our Sole Authority in all matters Spiritual.</>,
...
export const ministries = [
  {
    ...
    body: "Ms. Carol serves as SWCF's Director of Children's Ministry and VBS. Children's Church and Sunday School meet Sunday mornings during our Worship Service. Vacation Bible School meets in August for a week of music, lessons, and Gospel teaching for community kids.\n\nCarol grew up in a Christian home and as a child attended a Bible-believing, missions-minded church. Carol asked Christ to be her Savior at age nine and grew in  faith, sensing the call to teach children about Christ. Carol attended Philadelphia College of Bible. She has been a Bible teacher for forty years!\n\nCarol feels that it is crucial that children be influenced to stand strong for God in this culture. She Prays that this new generation will understand the good news of salvation and be truly committed to Him. In turn, she hopes that they will be equipped to spread the good news of Christ to others!",
